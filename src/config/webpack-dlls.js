...
module.exports = {
  ...
  output: {
    path: path.join(paths.assets, 'dlls'),
  ...
  entry: {
    vendor: [
      ...
      // list all packages that should be converted in a dll here
      'draft-js',
  ...
  resolve: {
    root: path.join(paths.root, 'node_modules'),
    extensions: ['', '.js'],
    postfixes: [],
  },
  ...
  plugins: [
    ...
    new webpack.DllPlugin({
      path: path.join(paths.webpackCache, 'dlls', '[name].json'),
